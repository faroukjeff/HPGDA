...
int main(int argc, char **argv) {
    ...
    for(uint64_t i = 0; i < num_iterations; i++){
        ...
        auto *graph = new GraphAlgorithm<AdjNew>(v,e);
        //auto *graph = new GraphAlgorithm<AdjacencyList>(v,e); //initial implementation
        //auto *graph = new GraphAlgorithm<AdjList>(v,e); //used for testing only
